...
migrate((app) => {
  ...
  const photosCollection = app.findCollectionByNameOrId("photos");
  ...
  const collection = new Collection({
    ...
    "fields":     [
          ...
          },
          {
                ...
                "type": "relation",
                "cascadeDelete": false,
                "collectionId": photosCollection.id,
                "displayFields": [],
                "maxSelect": 1,
                "minSelect": 0
          },
  ...
  try {
    const collection = app.findCollectionByNameOrId("pbc_1272723569");
